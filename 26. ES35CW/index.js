...
const printBookInfo = ({title: bookTitle, author: {name: authorName, nationality: authorNationality}}) => {
  console.log(`Book: ${bookTitle}, Author: ${authorName}, Nationality: ${authorNationality}`)
}
